...
almostallperls() {
    for perl in 8.8 8.9 10.0 10.1 12.5 14.4 16.3 18.4 20.3 22.4 24.4 26.3 28.3 30.3 32.1 34.3 36.3 38.2 39.6 ; do
...
allperls () {
    for perl in 8.1 8.5 8.8 8.9 10.0 10.1 12.5 14.4 16.3 18.4 20.3 22.4 24.4 26.3 28.3 30.3 32.1 34.3 36.3 38.2 39.6 ; do
        perlbrew use ${perl}@std;
        echo; echo using $PERL5LIB
        eval $(printf "%q " "$@")
        #$@
...
modernperls() {
    for perl in 20.3 22.4 24.4 26.3 28.3 30.3 32.1 34.3 36.3 38.2 39.6 ; do
        perlbrew use ${perl}@std;
        echo; echo using $PERL5LIB
        eval $(printf "%q " "$@")
