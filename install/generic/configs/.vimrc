...
map ,jd   :set paste<CR>O->or(sub {<CR>use Data::Dumper;<CR>local $Data::Dumper::Sortkeys = 1;<CR>local $Data::Dumper::Maxdepth = 5;<CR>diag 'got response: ', Dumper(shift->tx->res->json) });<ESC>:set nopaste<CR>o
